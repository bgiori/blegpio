...
uint8_t g_dev_addr[BLE_DEV_ADDR_LEN] = {0x59, 0xAE, 0xD4, 0x09, 0x34, 0x47};
...
/* I/O Polling task */
#define IO_POLL_TASK_PRIO           (2)
#define IO_POLL_STACK_SIZE          (OS_STACK_ALIGN(256))
struct os_task io_poll_task;
os_stack_t io_poll_stack[IO_POLL_STACK_SIZE];
/* I/O poll new subscriber event queue */
struct os_eventq io_poll_evq;
struct os_event io_ev;
/* Local conn_handle variable and getter to be used in gatt_svc */
